/*
  ...
  $Id: conf.lex,v 1.1.1.1 2019/04/06 10:36:08 cvs Exp $
 */
...
xor-key		    return trap_tk(TK_XOR_KEY);
confusing-key	    return trap_tk(TK_CONFUSING_KEY);
remote-server	    return trap_tk(TK_REMOTE_SERVER);
bind-address        { 
